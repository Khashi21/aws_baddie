...
import { Star, Shield, Verified, ThumbsUp, MessageSquare, ChevronDown, ChevronUp } from "lucide-react";
  ...
  const reviews = [
    {
      ...
      "comment": "I was followed and harassed by a group of local boatmen who kept pressuring me to take their services. One even used abusive language when I declined. I felt unsafe and had to leave the area.",
      "date": "1 day ago",
      "helpful": 41,
      "category": "Harassment",
      "department": "Tourist Police",
      "resolved": false,
      "currentStatus": "Complaint acknowledged. Awaiting investigation by local authorities."
    },
    {
      "id": 2,
      "name": "Sneha Rathi",
      ...
      "comment": "Visitors were seen scratching names and drawing symbols on the inner walls of the Taj Mahal. Security personnel were present but did not intervene. It's heartbreaking to see a world heritage site being damaged like this.",
      "date": "3 days ago",
      "helpful": 52,
    ...
    },
    {
      ...
      resolved: false,
      currentStatus: "Under investigation by state cyber cell for fraudulent practices."
    },
    {
      "id": 5,
      "name": "Fatima Khan",
      ...
      "comment": "After a trekking injury, I visited the government hospital. There was no doctor on duty for over 2 hours. The staff was unresponsive and refused to provide basic first aid until I paid unofficial charges.",
      "date": "4 days ago",
      "helpful": 47,
      "category": "Medical Services",
      "department": "Tourism & Health Department",
      "resolved": false,
      "currentStatus": "Escalated to state health authorities. Investigation initiated."
    }
    
  ];

  // Removed star rating UI for complaints
          ...
          <div className="lg:col-span-3">
            <div className="space-y-6">
              {reviews.map((review) => (
                <Card
                  key={review.id}
                  className={`p-6 shadow-card transition-all duration-200 ${expandedReviewId === review.id ? "ring-1 ring-primary" : ""}`}
                >
                  <div
                  ...
                  {expandedReviewId === review.id && (
                    ...
                    >
                      <div className="space-y-1">
                        ...
                        <Badge variant={review.resolved ? "secondary" : "destructive"} className="w-fit">
                          {review.resolved ? "Resolved" : "Not Resolved"}
                        </Badge>
                      </div>
                      <div className="space-y-1">
                        <div className="text-xs uppercase text-muted-foreground">Department</div>
                      ...
                      <div className="sm:col-span-3 space-y-1">
                        ...
                        <div className="text-sm text-foreground">{review.currentStatus}</div>
                      </div>
                    </div>
                  )}
                </Card>
